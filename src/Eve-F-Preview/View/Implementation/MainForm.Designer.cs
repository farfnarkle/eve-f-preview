...
namespace EveFPreview.View
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			NewPreviewSpawnLocationXNumericEdit = new NumericUpDown();
			NewPreviewSpawnLocationYNumericEdit = new NumericUpDown();
			SpawnXLabel = new Label();
			SpawnYLabel = new Label();
			NewPreviewAutoTileCheckBox = new CheckBox();
			...
			ShowSystemNameOnThumbnailCheckBox = new CheckBox();
			...
			((System.ComponentModel.ISupportInitialize)NewPreviewSpawnLocationXNumericEdit).BeginInit();
			((System.ComponentModel.ISupportInitialize)NewPreviewSpawnLocationYNumericEdit).BeginInit();
			...
			ContentTabControl.ItemSize = new Size(35, 130);
			...
			ContentTabControl.Size = new Size(455, 460);
			...
			GeneralSettingsPanel.Size = new Size(319, 330);
			...
			EnableAccountBasedThumbnailPositioningCheckBox.TabIndex = 31;
			EnableAccountBasedThumbnailPositioningCheckBox.Text = "Account based thumbnail positioning";
			EnableAccountBasedThumbnailPositioningCheckBox.UseVisualStyleBackColor = true;
			EnableAccountBasedThumbnailPositioningCheckBox.CheckedChanged += OptionChanged_Handler;
			// 
			...
			EnableAutoSettingsSyncCheckBox.TabIndex = 32;
			EnableAutoSettingsSyncCheckBox.Text = "Enable auto settings sync on startup";
			EnableAutoSettingsSyncCheckBox.UseVisualStyleBackColor = true;
			EnableAutoSettingsSyncCheckBox.CheckedChanged += OptionChanged_Handler;
			// 
			...
			AutoSettingsSyncStatusLabel.TabIndex = 33;
			AutoSettingsSyncStatusLabel.Text = "";
			// 
			...
			ThumbnailSettingsPanel.Controls.Add(NewPreviewAutoTileCheckBox);
			ThumbnailSettingsPanel.Controls.Add(SpawnYLabel);
			ThumbnailSettingsPanel.Controls.Add(NewPreviewSpawnLocationYNumericEdit);
			ThumbnailSettingsPanel.Controls.Add(SpawnXLabel);
			ThumbnailSettingsPanel.Controls.Add(NewPreviewSpawnLocationXNumericEdit);
			...
			// SpawnXLabel
			// 
			SpawnXLabel.AutoSize = true;
			SpawnXLabel.Location = new Point(9, 336);
			SpawnXLabel.Margin = new Padding(4, 0, 4, 0);
			SpawnXLabel.Name = "SpawnXLabel";
			SpawnXLabel.Size = new Size(50, 15);
			SpawnXLabel.TabIndex = 49;
			SpawnXLabel.Text = "Spawn X";
			// Hidden for now — spawn/auto-tile still wired in config + ThumbnailManager
			SpawnXLabel.Visible = false;
			// 
			// NewPreviewSpawnLocationXNumericEdit
			// 
			NewPreviewSpawnLocationXNumericEdit.BackColor = SystemColors.Window;
			NewPreviewSpawnLocationXNumericEdit.BorderStyle = BorderStyle.FixedSingle;
			NewPreviewSpawnLocationXNumericEdit.CausesValidation = false;
			NewPreviewSpawnLocationXNumericEdit.Location = new Point(65, 334);
			NewPreviewSpawnLocationXNumericEdit.Margin = new Padding(4);
			NewPreviewSpawnLocationXNumericEdit.Maximum = new decimal(50000);
			NewPreviewSpawnLocationXNumericEdit.Minimum = new decimal(-50000);
			NewPreviewSpawnLocationXNumericEdit.Name = "NewPreviewSpawnLocationXNumericEdit";
			NewPreviewSpawnLocationXNumericEdit.Size = new Size(56, 23);
			NewPreviewSpawnLocationXNumericEdit.TabIndex = 50;
			NewPreviewSpawnLocationXNumericEdit.Value = new decimal(new int[] { 0, 0, 0, 0 });
			NewPreviewSpawnLocationXNumericEdit.ValueChanged += OptionChanged_Handler;
			NewPreviewSpawnLocationXNumericEdit.Visible = false;
			// 
			// SpawnYLabel
			// 
			SpawnYLabel.AutoSize = true;
			SpawnYLabel.Location = new Point(128, 336);
			SpawnYLabel.Margin = new Padding(4, 0, 4, 0);
			SpawnYLabel.Name = "SpawnYLabel";
			SpawnYLabel.Size = new Size(14, 15);
			SpawnYLabel.TabIndex = 51;
			SpawnYLabel.Text = "Y";
			SpawnYLabel.Visible = false;
			// 
			// NewPreviewSpawnLocationYNumericEdit
			// 
			NewPreviewSpawnLocationYNumericEdit.BackColor = SystemColors.Window;
			NewPreviewSpawnLocationYNumericEdit.BorderStyle = BorderStyle.FixedSingle;
			NewPreviewSpawnLocationYNumericEdit.CausesValidation = false;
			NewPreviewSpawnLocationYNumericEdit.Location = new Point(152, 334);
			NewPreviewSpawnLocationYNumericEdit.Margin = new Padding(4);
			NewPreviewSpawnLocationYNumericEdit.Maximum = new decimal(50000);
			NewPreviewSpawnLocationYNumericEdit.Minimum = new decimal(-50000);
			NewPreviewSpawnLocationYNumericEdit.Name = "NewPreviewSpawnLocationYNumericEdit";
			NewPreviewSpawnLocationYNumericEdit.Size = new Size(56, 23);
			NewPreviewSpawnLocationYNumericEdit.TabIndex = 52;
			NewPreviewSpawnLocationYNumericEdit.Value = new decimal(new int[] { 0, 0, 0, 0 });
			NewPreviewSpawnLocationYNumericEdit.ValueChanged += OptionChanged_Handler;
			NewPreviewSpawnLocationYNumericEdit.Visible = false;
			// 
			// NewPreviewAutoTileCheckBox
			// 
			NewPreviewAutoTileCheckBox.AutoSize = true;
			NewPreviewAutoTileCheckBox.Location = new Point(13, 362);
			NewPreviewAutoTileCheckBox.Margin = new Padding(4);
			NewPreviewAutoTileCheckBox.Name = "NewPreviewAutoTileCheckBox";
			NewPreviewAutoTileCheckBox.Size = new Size(151, 19);
			NewPreviewAutoTileCheckBox.TabIndex = 53;
			NewPreviewAutoTileCheckBox.Text = "Auto-tile new previews";
			NewPreviewAutoTileCheckBox.UseVisualStyleBackColor = true;
			NewPreviewAutoTileCheckBox.CheckedChanged += OptionChanged_Handler;
			NewPreviewAutoTileCheckBox.Visible = false;
			// 
			...
			OverlaySettingsPanel.Controls.Add(ShowSystemNameOnThumbnailCheckBox);
			...
			ShowSystemNameOnThumbnailCheckBox.Size = new Size(166, 19);
			ShowSystemNameOnThumbnailCheckBox.TabIndex = 48;
			ShowSystemNameOnThumbnailCheckBox.Text = "Show system name (logs)";
			ShowSystemNameOnThumbnailCheckBox.UseVisualStyleBackColor = true;
			ShowSystemNameOnThumbnailCheckBox.CheckedChanged += OptionChanged_Handler;
			// 
			// ClientsTabPage
			// 
			...
			SettingsSyncTabPage.Location = new Point(124, 4);
			SettingsSyncTabPage.Margin = new Padding(4);
			SettingsSyncTabPage.Name = "SettingsSyncTabPage";
			SettingsSyncTabPage.Size = new Size(327, 243);
			SettingsSyncTabPage.TabIndex = 7;
			SettingsSyncTabPage.Text = "Settings Sync";
			// 
			// AboutTabPage
			// 
			...
			((System.ComponentModel.ISupportInitialize)NewPreviewSpawnLocationXNumericEdit).EndInit();
			((System.ComponentModel.ISupportInitialize)NewPreviewSpawnLocationYNumericEdit).EndInit();
		...
		private NumericUpDown NewPreviewSpawnLocationXNumericEdit;
		private NumericUpDown NewPreviewSpawnLocationYNumericEdit;
		private Label SpawnXLabel;
		private Label SpawnYLabel;
		private CheckBox NewPreviewAutoTileCheckBox;
