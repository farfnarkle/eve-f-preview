...
namespace EveFPreview.Configuration.Implementation
{
	sealed class ThumbnailConfiguration : IThumbnailConfiguration
	{
		...
		public ThumbnailConfiguration()
		{
			...
			this.ToggleThumbnailsHotkeys = new List<string>();
			this.ClickThroughModifierHotkeys = new List<string>();
			...
			this.EnableAccountBasedThumbnailPositioning = false;
			this.EnableAutoSettingsSync = false;
			this.AutoSettingsSyncSourceCharacterId = 0;
			this.AutoSettingsSyncSourceUserId = 0;
			...
			this.EnableCycleMouseDoubleClickProtection = false;
			...
			this.ShowSystemNameOnThumbnail = false;
		...
		[JsonProperty("EnableCycleMouseDoubleClickProtection")]
		public bool EnableCycleMouseDoubleClickProtection { get; set; }
		[JsonProperty("DynamicCycleGroup")]
		public bool DynamicCycleGroup { get; set; }

		[JsonProperty("EnableAccountBasedThumbnailPositioning")]
		public bool EnableAccountBasedThumbnailPositioning { get; set; }

		[JsonProperty("EnableAutoSettingsSync")]
		public bool EnableAutoSettingsSync { get; set; }

		[JsonProperty("AutoSettingsSyncSourceCharacterId")]
		public long AutoSettingsSyncSourceCharacterId { get; set; }

		[JsonProperty("AutoSettingsSyncSourceUserId")]
		public long AutoSettingsSyncSourceUserId { get; set; }

		[JsonProperty("AutoSettingsSyncDestinationCharacterIds")]
		public List<long> AutoSettingsSyncDestinationCharacterIds { get; set; }

		[JsonProperty("AutoSettingsSyncDestinationUserIds")]
		public List<long> AutoSettingsSyncDestinationUserIds { get; set; }
		...
		public bool ShowSystemNameOnThumbnail { get; set; }
		...
		[JsonProperty("NewPreviewSpawnLocation")]
		public Point NewPreviewSpawnLocation { get; set; }
		...
		[JsonProperty]
		public List<string> ToggleThumbnailsHotkeys { get; set; }
		[JsonProperty]
		public List<string> ClickThroughModifierHotkeys { get; set; }
		[JsonProperty]
		...
		public bool TryGetCharacterId(string windowTitle, out int characterId)
		{
			...
			if (this.ClientPortraitPaths == null
				|| !this.ClientPortraitPaths.TryGetValue(windowTitle, out string portraitPath)
				|| string.IsNullOrEmpty(portraitPath))
			{
				return false;
			}
		...
		public bool TryGetAccountIdForCharacter(int characterId, out int accountId)
		{
			...
			return this.CharacterAccountMap != null
				&& this.CharacterAccountMap.TryGetValue(characterId.ToString(), out accountId)
				&& accountId > 0;
		}
		...
		{
			// ConfigVersion 1 used MinimizeToTray for both tray behavior and startup minimize.
			// Version 2 splits those; migrate so existing tray users still start minimized.
			if (this.ConfigVersion < 2)
			{
				this.StartMinimized = this.MinimizeToTray;
